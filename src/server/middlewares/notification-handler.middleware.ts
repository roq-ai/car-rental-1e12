...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A guest has made a purchase on your platform. Please check the details and process the order..create': {
    roles: ['tenant-roles', 'tenant-owner-roles'],
    key: 'purchase',
    tenantPath: [],
    userPath: [],
  },
  'A user has added a new product to your platform. Please check the details and approve if necessary..create': {
    roles: ['tenant-roles'],
    key: 'product',
    tenantPath: [],
    userPath: [],
  },
  'A user has updated a product on your platform. Please check the details and approve if necessary..update': {
    roles: ['tenant-roles'],
    key: 'product',
    tenantPath: [],
    userPath: [],
