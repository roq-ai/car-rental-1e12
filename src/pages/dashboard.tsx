...
import { getVehicleInformations } from 'apiSdk/vehicle-informations';
...
function DashboardPage() {
  ...
  const vehicleInformationStat = useSWR<PaginatedInterface<VehicleInformationInterface>>(
    () => `/vehicle-informations`,
    () => getVehicleInformations({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: vehicleInformationStat?.data?.totalCount,
      isLoading: vehicleInformationStat.isLoading,
